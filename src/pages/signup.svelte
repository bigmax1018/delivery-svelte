				...
				<div class="form-elements">
					<form>
							...
							<ul class="grid grid-cols-1">
								<li class="item-content col-100 item-input item-input-with-value">
									<div class="item-inner">
										...
										<div class="item-input-wrap">
											<input type="text" placeholder="First Name" bind:value={name} class="form-control"/>
										</div>
									</div>
								</li>
								<li class="item-content col-100 item-input">
									<div class="item-inner">
										...
										<div class="item-input-wrap">
											<input type="email" placeholder="Email Address" class="form-control" bind:value={email}/>
										</div>
									</div>
								</li>
								<li class="item-content col-100 item-input">
									<div class="item-inner">
										...
										<div class="item-input-wrap">
											<input type="password" placeholder="Password" id="dz-password" bind:value={password} class="form-control"/>
											<div class="show-pass">
						...
						<div class="clearfix text-align-center pb-30">
							<a class="button-large button button-fill rounded-xl button-gray" on:click={register(email, password)}>SIGN UP</a>
