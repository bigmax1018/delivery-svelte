					...
					<div class="list search-list mt-0 mb-20 container searchbar-found item-list">
						<ul class="grid grid-cols-1 medium-grid-cols-2 grid-gap">
							...
							<li class="col-100 medium-50">
								<div class="item-bx item-list">
									<div class="dz-media">
										<a href="/item-details/"><img src="../assets/img/products/product3a.jpg" alt=""></a>
										<div class="rating"><i class="fa fa-star"></i> 3.8</div>
									</div>
									<div class="dz-info">
										<div class="dz-head">
							...
							<li class="col-100 medium-50">
								<div class="item-bx item-list">
									<div class="dz-media">
										<a href="/item-details/"><img src="../assets/img/products/product4.jpg" alt=""></a>
										<div class="rating"><i class="fa fa-star"></i> 3.8</div>
									</div>
									<div class="dz-info">
										<div class="dz-head">
					...
					<div class="list search-list mt-0 mb-20 container searchbar-found item-list">
						<ul class="grid grid-cols-1 medium-grid-cols-2 grid-gap">
							...
							<li class="col-100 medium-50">
								<div class="item-bx item-list">
									<div class="dz-media">
										<a href="/item-details/"><img src="../assets/img/products/product3.jpg" alt=""></a>
										<div class="rating"><i class="fa fa-star"></i> 3.8</div>
									</div>
									<div class="dz-info">
										<div class="dz-head">
