<Page name="home">
	...
	<div class="page-content content-area pt-40 pb-0">
		...
		<div class="container">
			...
			<!-- Products -->
			<swiper-container space-between={20} slides-per-view={'auto'} centered-slides={false} class="swiper swiper-init main-swiper mb-40 overlay-swiper1 demo-swiper-multiple demo-swiper-multiple-auto">
				<!-- <div class="swiper-wrapper"> -->
					<swiper-slide style="width:auto">
						<div class="card-overlay style-1 bg-primary">
							...
							<div class="dz-info">
								<h5 class="item-title title"><a href="/item-details/">Pizza Hut L Queso</a></h5>
								<div class="dz-meta">
									<ul>
					...
					<swiper-slide style="width:auto">
						<div class="card-overlay style-1 bg-primary">
							...
							<div class="dz-info">
								<h5 class="item-title title"><a href="/item-details/">KFC Combo Familia</a></h5>
								<div class="dz-meta">
									<ul>
										<li class="price"><sup>$</sup>5.8 <del>$9.9</del></li>
									</ul>
					...
					<swiper-slide style="width:auto">
						<div class="card-overlay style-1 bg-primary">
							...
							<div class="dz-info">
								<h5 class="item-title title"><a href="/item-details/">Tylenol Ultra</a></h5>
								<div class="dz-meta">
									<ul>
										<li class="price">$2.5 <del>$5.4</del></li>
									</ul>
					...
					<swiper-slide style="width:auto">
						<div class="card-overlay style-1 bg-primary">
							...
							<div class="dz-info">
								<h5 class="item-title title"><a href="/item-details/">BON XGrande</a></h5>
								<div class="dz-meta">
									<ul>
			...
			<swiper-container space-between={20} slides-per-view={'auto'} centered-slides={false} class="swiper swiper-init mb-40 main-swiper categories-swiper demo-swiper-multiple demo-swiper-multiple-auto">
				<!-- <div class="swiper-wrapper"> -->
					<swiper-slide style="width:auto">
