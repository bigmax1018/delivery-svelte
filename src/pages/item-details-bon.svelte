	...
	<div class="page light">
		...
		<div class="navbar navbar-style-1 navbar-transparent">
			<div class="navbar-inner">
				...
				<div class="title">Helados BON</div>
				<div class="right">
		...
		<div class="page-content item-details pt-0 pb-0">
			...
			<div class="dz-banner-heading bg-primary">
				<img src="../assets/img/products/single/pic5.png" class="bnr-img" alt=""/>
			</div>
			...
			<div class="fixed-content container">
				<div class="clearfix">
					<h3 class="ma-0">Helados BON Vanilla XL</h3>
					<p>Los mejores sabores de helado, con delivery mas rapido!</p>
				</div>
				...
				<div class="price-bx">
					<h2 class="price"><sup>$</sup>275<del>$399</del></h2>
...
<script>
    ...
    function placeOrder() {
        foodStore.set("Helados BON Vanilla XL");
    }
