	...
	<div class="page-content pt-0">
		...
		<img src="../assets/dronegif.gif" alt="gif" class="w-[50vw] ml-40" style="padding-bottom:20vh">
			...
			<div class="delivery-man container bg-primary">
				<div class="inner-content">
					...
					<div class="dz-content">
						<h5 class="title text-white">Drone #313</h5>
						<p class="text-white">"Sally"</p>
					</div>
					<div class="icon-area">
						<a href="#" class="icon-cell"><center>
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<a href="/messages/" class="icon-cell"><center>
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<div class="fixed-content container">
				<ul class="track-list">
					<li>
						<div class="icon-bx location"><center>
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<div class="info">
							<h5 class="title">Burger King</h5>
							<p>Avenida 27 Febrero, SD</p>
						</div>
					</li>
					<li>
						<div class="icon-bx"><center>
