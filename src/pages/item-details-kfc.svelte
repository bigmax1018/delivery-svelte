	...
	<div class="page light">
		...
		<div class="page-content item-details pt-0 pb-0">
			...
			<div class="dz-banner-heading bg-primary">
				<img src="../assets/img/products/single/pic3.png" class="bnr-img" alt=""/>
			</div>
			...
			<div class="fixed-content container">
				<div class="clearfix">
					<h3 class="ma-0">KFC Combo #2</h3>
					<p>Tres pedazos de pollo blanco con una bebida y biscit.</p>
				</div>
				<div class="item-rating">4.1</div>
				<div class="dz-range">
